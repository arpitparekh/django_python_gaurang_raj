...
SECRET_KEY = 'django-insecure-3g1k)d*$$$_(dtg@+n^b1hw1&chmlaq&3$ojt=wiml%so38y@#'
...
# SESSION_COOKIE_AGE = 20  # Session expires in 60 seconds
...
MEDIA_URL = '/userImage/'
MEDIA_ROOT = os.path.join(BASE_DIR, 'userImage')
